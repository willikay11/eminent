...
@section('main-content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="/activities"><i class=""></i> Activities</a></li>
            <li class="active">Acivity Details</li>
        </ol>
    </section>
                ...
                <div class="col-md-8">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <div class="pull-left">
                                <h3 class="box-title" style="padding-bottom: 25px">Activity Details</h3>
                            </div>
                        </div>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <el-col :xs="22" :sm="22" :md="22" :lg="20">
                                                    <el-form-item prop="name">
                                                        <el-input placeholder="Activity Name"
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <el-col :xs="22" :sm="22" :md="22" :lg="20">
                                                    <el-form-item prop="activityType">
                                                        <el-select v-model="ruleForm.activityType"
                                                ...
                                                <el-row :span="24" :gutter="20" v-if="ruleForm.activityType == 2">
                                                    ...
                                                    <el-col :xs="22" :sm="22" :md="22" :lg="20">
                                                        <el-form-item prop="projectedRevenue">
                                                            <el-input-number placeholder="Projected Revenue"
                                                                             v-model="ruleForm.projectedRevenue"></el-input-number>
                                                        </el-form-item>
                                                    </el-col>
                                                </el-row>
                                            </div>
                                        ...
                                        <el-popover
                                            ...
                                            <ul style="list-style:none">
                                                <el-upload
                                                    ...
                                                    <div class="el-upload__tip" slot="tip">files with a size less than
                                                        500kb
                                                    </div>
                                                </el-upload>
                                            </ul>
                                                        ...
                                                        <div class="msg">
                                                            ...
                                                            <div v-if="comment.files.length != 0">
                                                                <div v-for="file in comment.files">
                                                                    <img v-if="file.image == true" :src="file.path"
                                                                         draggable="false"/>
                                                                    <a v-if="file.image == false" class="edit"
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"
                                        ...
                                        <el-dialog
                                            ...
                                            <el-row :span="24">
                                                ...
                                                <el-form :model="progressRuleForm" :rules="progressRules"
                                                         ref="progressRuleForm" label-position="left">
                                                        ...
                                                        <el-row :span="24" :gutter="20">
                                                            ...
                                                            <el-col :xs="22" :sm="22" :md="22" :lg="20">
                                                                <el-form-item prop="status">
                                                                    <el-select v-model="progressRuleForm.status"
                                                            ...
                                                            <el-col :xs="22" :sm="22" :md="22" :lg="20">
                                                                <el-form-item prop="file">
                                                                    <el-upload
                                                                            ...
                                                                            :auto-upload="false">
                                                                        <el-button size="small" type="primary">Click to
                                                                            upload
                                                                        </el-button>
                                                                        <div slot="tip" class="el-upload__tip">jpg/png
                                        ...
                                        <span slot="footer" class="dialog-footer">
                                            <el-button @click
                                            ="updateTaskProgressDialogVisible = false">Cancel</el-button>
                                        ...
                                        <div style="background-color: white; margin-bottom: 20px">
                                            <el-button type="primary" @click="showAddTaskProgress">Update
                                            Progress</el-button>
                                        </div>

                                        <div class="form-item-container" v-if="progressUpdateData.length != 0"
                                             v-for="progressUpdate in progressUpdateData">
                                            <el-card class="box-card" style="margin-bottom: 20px">
                                                ...
                                                <el-row :span="24" :gutter="20">
                                                    <el-col :span="2" v-if="progressUpdate.progress_files.length != 0">
                                                        <el-badge :value="progressUpdate.progress_files.length"
                                                                  class="item">
                                                            <button class="btn" @click="
                                                            showTaskProgressFiles(progressUpdate.progress_files)"><i
                                                                    class="fa fa-file font-icon"
                                        ...
                                        <div class="row" style="margin-bottom: 20px"
                                             v-if="progressUpdateData.length == 0">
                                            <el-alert
                                                    title="No comments posted!"
                                                    type="info"
                                                    show-icon>
